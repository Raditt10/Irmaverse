                ...
                <>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div className="bg-slate-50 rounded-2xl p-4 border border-slate-200">
                        ...
                        <div className="flex gap-2 flex-wrap">
                          ...
                          {secInfo.hasGoogle && (
                            <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-white text-slate-700 border-2 border-slate-100 rounded-full text-xs font-bold shadow-sm">
                    ...
                    {secInfo.hasGoogle ? (
                      ...
                      <div className="space-y-4">
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-2 px-5 py-2.5 bg-white border-2 border-slate-200 text-slate-700 font-bold text-sm rounded-2xl hover:bg-slate-50 hover:border-emerald-500 hover:text-emerald-700 transition-all shadow-sm"
                        >
                  ...
                  <div className="bg-white border-2 border-slate-200 rounded-[2rem] p-6 shadow-[0_6px_0_0_#cbd5e1]">
                    ...
                    {secInfo.hasPassword ? (
                      ...
                      <div className="space-y-4 max-w-md">
                        <div className="flex items-start gap-2 p-3 bg-emerald-50 rounded-2xl border border-emerald-200">
