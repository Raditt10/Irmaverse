...
import { ArrowLeft, Eye, Edit3, Image as ImageIcon, Sparkles, Save, Upload } from "lucide-react";
...
export default function EditNewsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast("Berita berhasil diupdate! Mengalihkan...", "success");
      ...
      showToast("Gagal mengupdate berita. Silakan coba lagi.", "error");
    } finally {
      setLoading(false);
    }
  };
            ...
            <div className="flex flex-col gap-4 lg:gap-6 mb-6 lg:mb-8">
              ...
              <div>
                ...
                <p className="text-slate-500 font-medium text-sm lg:text-lg">
                  Edit berita Anda menggunakan format Markdown.
                </p>
              ...
              <div className="space-y-6 lg:space-y-8">
                ...
                <div className="bg-white p-5 lg:p-6 rounded-3xl lg:rounded-[2.5rem] border-2 border-slate-200 shadow-[0_4px_0_0_#cbd5e1] lg:shadow-[0_8px_0_0_#cbd5e1] text-center">
                  <label className="block text-xs lg:text-sm font-bold text-slate-600 mb-3 lg:mb-4">
                    Thumbnail Berita <span className="text-red-500 ml-1 font-bold">*</span>
                  </label>
                ...
                <div className="bg-teal-500 p-6 rounded-[2.5rem] text-white border-2 border-teal-600 shadow-[0_6px_0_0_#0d9488] mb-8">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-xl font-black">Siap Simpan?</h3>
                  </div>
                  <button
                    type="submit"
                    disabled={loading}
                  ...
                  <p className="text-xs text-teal-100 font-bold mt-4 text-center opacity-80">
                    Perubahan akan langsung diperbarui di portal berita.
                  </p>
                </div>
              </div>
            </form>
